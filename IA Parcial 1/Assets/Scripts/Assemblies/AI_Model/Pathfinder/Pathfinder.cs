...
{
    public abstract class Pathfinder<NodeType> where NodeType : INode<UnityEngine.Vector2Int>, INode, new()
    {
        public Graph<NodeType> graph;

        public abstract List<NodeType> FindPath(NodeType startNode, NodeType destinationNode);
        // {
        ...
        //         }
        //
        //         foreach (NodeType neighbor in graph.GetNeighbours(currentNode))
        //         {
        ...
        protected abstract List<NodeType> GetValidNeighbours(NodeType node);
