...
namespace RTS.Model
{
    public sealed class Convoy : TravelerAgent
    {
        ...
        protected override void AddStates()
        {
            ...
            fsm.AddState<MineState>(States.Work, onTickParams: () => new object[] { map.headquarters, inventory, miningSpeed });
            fsm.AddState<UnloadState>(States.Unload, onTickParams: () => new object[] { closestMineNode.heldEntity, inventory, unloadingSpeed });
        }
